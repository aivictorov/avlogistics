                        ...
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <x-input type="text" class="form-control" id="name" name="name" value="{{ $page['name'] }}"/>
                                </div>
                                <div class="form-group">
                                    <label for="h1">Заголовок</label>
                                    <x-input type="text" class="form-control" id="h1" name="h1" value="{{ $page['h1'] }}"/>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <x-input type="text" class="form-control" id="url" name="url" value="{{ $page['url'] }}"/>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
