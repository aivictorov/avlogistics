...
/* harmony export */   "default": () => (/* binding */ old)
/* harmony export */ });
function old() {
...
/*!******************************!*\
  ...
  \******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _old__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./old */ "./resources/js/old.js");
...
function gallery() {
  ...
  portfolio_inslider.style.width = (bigimages.length + 1) * 670 + "px";
  var cur_counter = 0;
  var inmove = false;
  miniimages.forEach(function (image) {
  ...
  right.addEventListener('click', function () {
    if (!inmove) {
      ...
      portfolio_inslider.style.left = parseInt(portfolio_inslider.style.left) - 670 + "px";
      inmove = false;
      miniimages.forEach(function (image) {
        image.classList.remove('cur');
      });
  ...
  left.addEventListener('click', function () {
    if (!inmove) {
      ...
      if (cur_counter < 0) {
        ...
        portfolio_inslider.style.left = "-" + (portfolio_count - 1) * 670 + "px";
      }
      inmove = true;
      if (!portfolio_inslider.style.left) {
        portfolio_inslider.style.left = 0 + "px";
  ...
  miniimages.forEach(function (image) {
    image.addEventListener('click', function () {
      inmove = true;
      portfolio_inslider.style.left = "-" + parseInt(image.dataset.counter) * 670 + "px";
